var config = {
	...
	latitude_comment: "Update latitude (a decimal number) then delete latitude_comment",
	latitude: 0,
	longitude_comment: "Update longitude (a decimal number) then delete longitude_comment",
	longitude: 0,
	az: 0,
